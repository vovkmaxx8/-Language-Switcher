// switcher.js
// Language Switcher (Auto-detect) на JavaScript (Node.js)
...
const ENG_TO_RUS = Object.fromEntries(Object.entries(RUS_TO_ENG).map(([k,v]) => [v,k]));
...
function detectLanguage(text) {
    ...
    for (const c of text) {
        ...
        else if (c.match(/[a-zA-Z]/)) engCount++;
    }
...
for (let i = 0; i < args.length; i++) {
    if (args[i] === '-r' || args[i] === '--reverse') {
        ...
        console.log(`Использование: node switcher.js [опции] [текст]
